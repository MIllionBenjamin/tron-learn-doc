...
![tronlink_wallet.png](./image/tronlink_wallet.png)

访问[Nile测试网获取代币网址](https://nileex.io/join/getJoinPage)，粘贴Tron钱包地址，并点击`Obtain`。无误后会弹窗提示获取成功。

![tron_test_coins_request.png](./image/tron_test_coins_request.png)

在TronLink中将钱包切至Nile测试网，发现2000代币已到账。

![switch_to_tron_nile_testnet.png](./image/switch_to_tron_nile_testnet.png)
...
![tronlink_enter_receiver_addr.png](./image/tronlink_enter_receiver_addr.png)


![tronlink_enter_amount.png](./image/tronlink_enter_amount.png)


然后点击`Send`，确认转账详情，点击`Sign`签署交易。

![tronlink_sign_transaction.png](./image/tronlink_sign_transaction.png)


片刻后可在钱包首页点击币种查看交易记录。

![tronlink_choose_currency.png](./image/tronlink_choose_currency.png)


![tronlink_transactions.png](./image/tronlink_transactions.png)